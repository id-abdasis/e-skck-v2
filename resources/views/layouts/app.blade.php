                    ...
                    <div class="block pull-r-l">
                        ...
                        <div class="block-content">
                            <ul class="nav-users push">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="{{ url('/') }}/assets/media/avatars/avatar13.jpg" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="{{ url('/') }}/assets/media/avatars/avatar3.jpg" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="{{ url('/') }}/assets/media/avatars/avatar16.jpg" alt="">
