 ...
 <div class="content-header">
    ...
    <div class="content-header-section d-none d-lg-block">
        ...
        <ul class="nav-main-header">
            <li>
                <a class="active" href="bd_dashboard.html"><i class="si si-compass"></i>Bantuan</a>
            </li>
        </ul>
...
<!-- END Header Loader --><?php /**PATH C:\laragon\www\e-skck-v2\resources\views/includes/header.blade.php ENDPATH**/ ?>