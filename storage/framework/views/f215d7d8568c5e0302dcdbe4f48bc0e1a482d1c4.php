...
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css">
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/select2/css/select2.min.css">
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/jquery-tags-input/jquery.tagsinput.min.css">
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/jquery-auto-complete/jquery.auto-complete.min.css">
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/ion-rangeslider/css/ion.rangeSlider.css">
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/dropzonejs/dist/dropzone.css">
<link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/js/plugins/flatpickr/flatpickr.min.css">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="js-wizard-validation-classic block" id="">
                ...
                <!-- Form -->
                <form class="js-wizard-validation-classic-form" enctype="multipart/form-data" id="" action="<?php echo e(route('store-skck')); ?>" method="post">
                    <!-- Steps Content -->
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="tab-pane" id="wizard-validation-classic-step2" role="tabpanel">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Masukan Nama Lengkap" id="nama_lengkap_pendaftar" name="nama_lengkap_pendaftar" valu="<?php echo e(old('nama_lengkap_pendaftar')); ?>"> 
                                    </div>
        
                                    <div class="form-row">
                                        <div class="form-group col-md-7">
                                            <label for="tempat_lahir_pendaftar">Tempat Lahir</label>
                                            <input required type="text" placeholder="Masukan Tempat Lahir" class="form-control" name="tempat_lahir_pendaftar" id="tempat_lahir_pendaftar" value="<?php echo e(old('tempat_lahir_pendaftar')); ?>" >    
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input required class="form-control" type="text" name="pekerjaan_pendaftar" value="<?php echo e(old('pekerjaan_pendaftar')); ?>" placeholder="Masukan Pekerjaan Anda">
                                        </div>
        
                                        <div class="form-group col-md-4">
                                            <label for="telepon_pendaftar">Telepon</label>
                                            <input required class="form-control" type="text" name="telepon_pendaftar" value="<?php echo e(old('telepon_pendaftar')); ?>" placeholder="Masukan Telepon Anda">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input required class=" form-control isMaxLength" maxlength="18" type="text" id="nomor_identitas_pendaftar" name="nomor_identitas_pendaftar" value="<?php echo e(old('nomor_identitas_pendaftar')); ?>" placeholder="Masukan Identitas Anda" >
                                        </div>
        
                                        <div class="form-group col-md-4">
                                            <label for="nomor_paspor_pendaftar">Nomor Paspor</label>
                                            <input class="form-control" type="text" id="nomor_paspor_pendaftar" name="nomor_paspor_pendaftar" value="<?php echo e(old('nomor_paspor_pendaftar')); ?>" placeholder="Masukan Paspor Anda">
                                        </div>
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="data_pasangan">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-7">
                                            ...
                                            <input focused  type="text" placeholder="Masukan Nama Lengkap Pasangan" class="form-control" name="nama_lengkap_pasangan" id="nama_lengkap_pasangan" value="<?php echo e(old('tempat_lahir_pasangan')); ?>" >    
                                        </div>
        
                                        <div class="form-group col-md-2">
                                            <label for="umur">Umur</label>
                                            <input  type="text" placeholder="Umur Pasangan" class="form-control" name="umur_pasangan" id="umur_pasangan" value="<?php echo e(old('umur_pasangan')); ?>" >    
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input class="form-control" type="text" name="pekerjaan_pasangan" value="<?php echo e(old('pekerjaan_pasangan')); ?>" placeholder="Masukan Pekerjaan Anda">
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input required type="text" placeholder="Masukan Nama Lengkap ayah" class="form-control" name="nama_lengkap_ayah" id="nama_lengkap_ayah" value="<?php echo e(old('tempat_lahir_ayah')); ?>" >    
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-7">
                                        ...
                                        <input required class="form-control" type="text" name="pekerjaan_ayah" value="<?php echo e(old('pekerjaan_ayah')); ?>" placeholder="Masukan Pekerjaan Anda">
                                    </div>


                                    <div class="form-group col-md-2">
                                            <label for="umur">Umur</label>
                                            <input required required type="text" placeholder="Umur ayah" class="form-control" name="umur_ayah" id="umur_ayah" value="<?php echo e(old('umur_ayah')); ?>" >    
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input required type="text" placeholder="Masukan Nama Lengkap ibu" class="form-control" name="nama_lengkap_ibu" id="nama_lengkap_ibu" value="<?php echo e(old('tempat_lahir_ibu')); ?>" >    
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-7">
                                        ...
                                        <input required class="form-control" type="text" name="pekerjaan_ibu" value="<?php echo e(old('pekerjaan_ibu')); ?>" placeholder="Masukan Pekerjaan Anda">
                                    </div>

                                    <div class="form-group col-md-2">
                                        <label for="umur">Umur</label>
                                        <input required type="text" placeholder="Umur ibu" class="form-control" name="umur_ibu" id="umur_ibu" value="<?php echo e(old('umur_ibu')); ?>" >    
                                    </div>
                                </div>
                                ...
                                <div class="data-saudara">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input  type="text" placeholder="Masukan Nama Lengkap saudara" class="form-control" name="nama_lengkap_saudara[]" id="nama_lengkap_saudara" value="<?php echo e(old('tempat_lahir_saudara')); ?>" >    
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-7">
                                            ...
                                            <input  class="form-control" type="text" name="pekerjaan_saudara[]" value="<?php echo e(old('pekerjaan_saudara')); ?>" placeholder="Masukan Pekerjaan Anda">
                                        </div>
        
                                        <div class="form-group col-md-2">
                                            <label for="umur">Umur</label>
                                            <input  type="text" placeholder="Umur saudara" class="form-control" name="umur_saudara[]" id="umur_saudara" value="<?php echo e(old('umur_saudara')); ?>" >    
                                        </div>
                                    </div>
                           ...
                           <div class="col-md-12">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input required class=" form-control " maxlength="18" type="text" id="nama_sekolah" name="nama_sekolah" value="<?php echo e(old('nama_sekolah')); ?>" placeholder="Masukan Nama Sekolah" >
                                    </div>
    
                                    <div class="form-group col-md-4">
                                        <label for="tahun_lulus">Tahun Lulus</label>
                                        <input required class="form-control" type="text" id="tahun_lulus" name="tahun_lulus" value="<?php echo e(old('tahun_lulus')); ?>" placeholder="Masukan Tahun Lulus">
                                    </div>
                                </div>
...
<?php $__env->startSection('plugin-js'); ?>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/bootstrap-wizard/jquery.bootstrap.wizard.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/jquery-validation/jquery.validate.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/jquery-validation/localization/messages_id.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/jquery-validation/additional-methods.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/pwstrength-bootstrap/pwstrength-bootstrap.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/select2/js/select2.full.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/jquery-tags-input/jquery.tagsinput.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/jquery-auto-complete/jquery.auto-complete.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/masked-inputs/jquery.maskedinput.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/ion-rangeslider/js/ion.rangeSlider.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/dropzonejs/dropzone.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/plugins/flatpickr/flatpickr.min.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/creative.js"></script>
<script src="<?php echo e(url('/')); ?>/assets/js/jsrows.js"></script>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-js'); ?>
<script src="<?php echo e(url('/')); ?>/assets/js/pages/be_forms_wizard.min.js"></script>
<script src="assets/js/pages/be_forms_plugins.min.js"></script>

<script>jQuery(function(){ Codebase.helpers(['flatpickr', 'datepicker', 'colorpicker', 'maxlength', 'select2', 'masked-inputs', 'rangeslider', 'tags-inputs']); });</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app-client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-skck-v2\resources\views/layouts/client-side/pendaftaran-skck.blade.php ENDPATH**/ ?>